...
ration_url_page2 = 'https://www.moneycontrol.com/financials/hdfcbank/ratiosVI/HDF01/2#HDF01'

#Append data from page two to the same csv file
r = requests.get(ration_url_page2)
htmlContent = r.content
soup = BeautifulSoup(htmlContent, 'html.parser')
...
pnl_url_page2 = 'https://www.moneycontrol.com/financials/hdfcbank/profit-lossVI/HDF01/2#HDF01'

#Append data from page two to the same csv file
r = requests.get(pnl_url_page2)
htmlContent = r.content
soup = BeautifulSoup(htmlContent, 'html.parser')
...
yearly_results_url_page2 = 'https://www.moneycontrol.com/financials/hdfcbank/consolidated-results/yearly/HDF01/2#HDF01'

#Append data from page two to the same csv file
r = requests.get(yearly_results_url_page2)
htmlContent = r.content
soup = BeautifulSoup(htmlContent, 'html.parser')
